...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        pixmap = QPixmap("assets/images/passwort-generator.jpg")  # Pfad zum Hintergrundbild
        self.background_label.setPixmap(pixmap)
        self.background_label.setScaledContents(True)
        self.background_label.setGeometry(self.rect())
        self.background_label.lower()  # Hintergrundbild in den Hintergrund setzen

        # Titel und Beschreibung
        title_label = QLabel("Passwortmanager")
        title_label.setObjectName("title_label")  # Objekt-ID für QSS-Styling
        layout.addWidget(title_label)

        description_label = QLabel("Verwalten und generieren Sie sichere Passwörter.")
        description_label.setObjectName("description_label")  # Objekt-ID für QSS-Styling
    ...
    def open_add_entry_dialog(self, first_name="", last_name="", password=""):
        """
        Öffnet den Dialog zum Hinzufügen eines neuen Passwort-Eintrags
        und speichert den Eintrag, wenn der Dialog erfolgreich abgeschlossen wird.
        """
    ...
    def open_password_generator(self):
        """
        Öffnet den Passwortgenerator-Dialog und verwendet das generierte Passwort,
        wenn der Benutzer den Dialog akzeptiert.
        """
    ...
    def show_password_list(self):
        """
        Öffnet das Fenster zur Anzeige aller gespeicherten Passwörter.
        """
